...
- New entries, manual retries, and automatic reentries are restricted to the selected market's cached top 30 USDT perpetual contracts by 24-hour turnover. Position closes always bypass this filter. The four rankings refresh on startup and every 24 hours; a failed market refresh keeps that market's last successful snapshot.
